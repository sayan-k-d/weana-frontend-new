            ...
            <Container maxWidth="lg">
                <Grid container spacing={{ xs: 4, md: 6 }} sx={{ mb: { xs: 4, md: 5 } }}>
                    <Grid size={{ xs: 12, md: 4 }}>
                        ...
                        <Typography sx={{ mt: 1.4, fontSize: { xs: 15, md: 14 }, color: 'rgba(255,255,255,0.9)', lineHeight: 1.45, maxWidth: 310 }}>
                ...
                <Box sx={{ borderTop: '1px solid rgba(255,255,255,0.14)', pt: 2.2, pb: 2.2, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
                    ...
                    <Stack direction="row" spacing={3}>
                        {['Terms of Service', 'Privacy Policy'].map((l) => (
                            <Typography key={l} component={Link} href="#" sx={{ fontSize: { xs: 13, md: 12 }, color: 'rgba(255,255,255,0.9)', textDecoration: 'none' }}>{l}</Typography>
                        ))}
                    </Stack>
