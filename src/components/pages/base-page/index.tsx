    ...
    >
      ...
      <Box
        sx={{
          ...
          inset: 0,
          background:
            "linear-gradient(90deg, rgba(3,2,8,0.86) 0%, rgba(3,2,8,0.58) 42%, rgba(3,2,8,0.28) 100%)",
          zIndex: 1,
        }}
      />
      ...
      <Box sx={{ position: "relative", zIndex: 2 }}>
        ...
        <Container
          maxWidth="lg"
          sx={{ mt: { xs: 8, md: 16 }, pb: { xs: 10, md: 14 } }}
        >
          {!heroReady ? (
            <Box
              sx={{
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Typography
                  sx={{
                    ...
                    mb: 2,
                    animation:
                      "heroFadeUp 1.35s cubic-bezier(0.22, 1, 0.36, 1) both",
                  }}
                >
                ...
                <Typography
                  sx={{
                    fontSize: { xs: 16, md: 33 },
                    color: "rgba(255,255,255,0.86)",
                    mb: 3.5,
                    lineHeight: 1.35,
                    animation:
                      "heroFadeUp 1.5s cubic-bezier(0.22, 1, 0.36, 1) both",
                ...
                <Button
                  ...
                  sx={{
                    ...
                    textTransform: "none",
                    animation:
                      "heroFadeUp 1.65s cubic-bezier(0.22, 1, 0.36, 1) both",
                    animationDelay: "180ms",
                    transition:
                      "transform 360ms ease, box-shadow 360ms ease, background 320ms ease",
                    "&:hover": {
                      background: "#6B3EA0",
                      transform: "translateY(-2px)",
                      boxShadow: "0 14px 28px rgba(123,73,177,0.35)",
                    },
                  }}
                >
      ...
      <Container maxWidth="xl">
        <Box sx={{ textAlign: "center", mb: { xs: 4, md: 5 } }}>
          ...
          >
            ...
            <br />
            Build your profile in seconds and share it via your QR code, Apple
            Wallet
            <br />
            or NFC.
          </Typography>
            ...
            <Grid key={card.title} size={{ xs: 12, md: 4 }}>
              <Box
                sx={{
                  ...
                  transition:
                    "transform 420ms cubic-bezier(0.22, 1, 0.36, 1), box-shadow 420ms ease, border-color 360ms ease",
                  animation:
                    "howCardIn 1.2s cubic-bezier(0.22, 1, 0.36, 1) both",
              ...
              >
                ...
                <Typography
                  sx={{ fontSize: 12, color: "#55525F", lineHeight: 1.5 }}
                >
                  {card.desc}
                </Typography>
              </Box>
...
function TeamCTA() {
  const stats = [
    ...
    },
    {
      ...
      icon: (
        <MarkEmailUnreadOutlinedIcon sx={{ fontSize: 34, color: "#6F42B4" }} />
      ),
    },
    {
      value: "9 days",
    ...
    <Box sx={{ background: "#FFF", mt: 10, py: { xs: 7, md: 10 } }}>
      <Container maxWidth="xl">
        <Box sx={{ maxWidth: 1240, mx: "auto" }}>
          ...
          >
            Companies spend big on events, but lack a system that turns those
            moments into measurable revenue.
          </Typography>
          ...
          >
            These stats are based on hundreds of real customer conversations and
  ...
  <Box sx={{ position: "relative", display: "inline-block" }}>
    <Box
      sx={{
        ...
        width: 220,
        height: 130,
        background: "linear-gradient(135deg, #C4A0E8, #9B6FD0)",
        borderRadius: 16,
    ...
    <Box
      sx={{
        ...
        height: 140,
        background:
          "linear-gradient(135deg, #A78FD8 0%, #7B5EA7 40%, #9B8FE8 100%)",
        borderRadius: 16,
        boxShadow: "0 8px 32px rgba(123,94,167,0.3)",
        overflow: "hidden",
        p: 2,
      }}
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
        <Box
          sx={{
            ...
            height: 44,
            borderRadius: "50%",
            background: "linear-gradient(135deg, #E8D5A0, #C4A070)",
        ...
        >
          <Box
            sx={{
              width: 28,
              height: 36,
              background: "linear-gradient(180deg, #D4956A, #C07050)",
      ...
      <Stack spacing={0.6} sx={{ mt: 1.5 }}>
        {[PhoneOutlinedIcon, EmailOutlinedIcon, LanguageOutlinedIcon].map(
          (Icon, i) => (
    ...
    <Box sx={{ background: "#fff", py: { xs: 6, md: 9 } }}>
      <Container maxWidth="xl">
        ...
        <Grid
          container
          spacing={2.2}
          sx={{ px: "7rem", maxWidth: "1360px", mx: "auto" }}
        >
          <Grid size={{ xs: 12, md: 6 }}>
            <Stack spacing={2.5}>
              <Box
                sx={{
                  ...
                  "&:hover": {
                    ...
                    boxShadow: "0 18px 34px rgba(23,19,33,0.12)",
                  },
                }}
              >
                <Typography
                ...
                >
                  Consistency, Crafted to Perfection
                </Typography>
                <Typography
                  sx={{
                    fontSize: 14,
                ...
                >
                  Your logo. Your colors. Your voice. Seamlessly aligned across
                  every profile.
                </Typography>
                <Box
                  sx={{
              ...
              >
                ...
                >
                  Crafted to support growth at every stage
                </Typography>
                <Typography
                  sx={{
                    fontSize: 14,
                ...
                >
                  Streamline employee onboarding and maintain full cost control.
                  With Weana, your technology evolves as your organization
                  grows.
                </Typography>
                <Box
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Stack spacing={2.5}>
              ...
              >
                ...
                >
                  Instant CRM integration. <br /> Zero complexity
                </Typography>
                <Typography
                  sx={{
                    fontSize: 14,
                ...
                >
                  Generate new leads while centralizing all your contacts in one
                  place. With Weana, your contact data syncs seamlessly to your
                  chosen CRM.
                </Typography>
                <Box
                  sx={{ mt: "auto", display: "flex", justifyContent: "center" }}
              ...
              >
                ...
                >
                  Centralized control with refined administrative oversight.
                </Typography>
                <Typography
                  sx={{
                    fontSize: 14,
                ...
                >
                  Weana enables scalable user management through a centralized
                  admin console.
                </Typography>
                <Box
                  sx={{ mt: "auto", display: "flex", justifyContent: "center" }}
      ...
      >
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 2 }}>
          <Box sx={{ textAlign: "center", mb: 4 }}>
            ...
            <Typography sx={{ color: "#000", fontSize: 16, mb: 4 }}>
              Make every first impression unforgettable with Weana.
            </Typography>
            <Button
              sx={{
                background: "#7B5EA7",
          ...
          >
            {["ava.png", "william.png", "daniel.png", "amelia.png"].map(
              (img, i) => (
                <Box
                  key={i}
                  component="img"
            ...
            <Grid key={item.title} size={{ xs: 12, md: 6 }}>
              <Box
                sx={{
                  ...
                  background:
                    "linear-gradient(180deg, #F4E9FF 0%, #FFFFFF 100%)",
                  ...
                  transition:
                    "transform 300ms cubic-bezier(0.22, 1, 0.36, 1), box-shadow 300ms ease",
                  "&:hover": {
...
function ConnectionsOrganized() {
  return (
    <Box
      sx={{ background: "#fff", pt: { xs: 7, md: 10 }, pb: { xs: 2, md: 3 } }}
    >
      <Container maxWidth="xl">
        <Box sx={{ textAlign: "center", mb: 5 }}>
          ...
          >
            ...
            <br />
            Turn meetings into lasting relationships with features built for
        ...
        <Grid
          container
          spacing={2.4}
          sx={{ maxWidth: 1160, mx: "auto", alignItems: "stretch" }}
        >
          <Grid size={{ xs: 12, md: 6 }}>
            <Box
              sx={{
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            >
              ...
              <Box sx={{ display: "grid", gap: 1.3, mt: "auto", pt: 1 }}>
                {["Olivia Reed", "Ava Thompson", "Mia Anderson"].map(
                  (name, idx) => (
                    <Box
                      key={name}
                      sx={{
...
function EventFeatures() {
  ...
  return (
    <Box
      sx={{ background: "#fff", pt: { xs: 1, md: 1.5 }, pb: { xs: 6, md: 8 } }}
    >
      <Container maxWidth="xl">
...
function SustainabilityCalculator() {
  const statCards = [
    {
      title: "Total costs saved per year by switching from paper to digital:",
      value: "$38,620",
    },
    ...
    <Box sx={{ background: "#fff", py: { xs: 7, md: 11 } }}>
      <Container maxWidth="xl">
        ...
        <Grid
          container
          spacing={3}
          sx={{ maxWidth: 1220, mx: "auto", alignItems: "stretch" }}
        >
          <Grid size={{ xs: 12, md: 7 }}>
            ...
            <Typography
              sx={{ textAlign: "center", fontSize: 12, color: "#333", mb: 2.2 }}
            >
            ...
            <Box sx={{ px: { xs: 0, md: 1.5 }, mb: 3 }}>
              ...
              >
                {["$0.20", "$0.40", "$0.60", "$0.80", "$1"].map((v) => (
                  <Typography key={v} sx={{ fontSize: 12 }}>
                    {v}
                  </Typography>
                ))}
              </Box>
