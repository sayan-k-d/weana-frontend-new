  ...
  return (
    <PageWrapper>
      {accountType === "" ? (
            ...
            <Stack spacing={2}>
              ...
              >
                ...
                <Image
                  src="/images/team.png"
                  alt="team"
                  width={isSmallLaptop ? 60 : 81}
                  height={isSmallLaptop ? 60 : 81}
                />
                <Box sx={{ flex: 1 }}>
                  <Typography
                    sx={{ fontSize: "14px", fontWeight: 700, color: "#1A1A3E" }}
                  >
                    My Team
                  </Typography>
                  <Typography
                    sx={{ fontSize: "12px", color: "#888", lineHeight: 1.4 }}
                  >
        ...
        <MyselfSignUpView onBack={handleBack} />
      ) : (
        <LeftPane>
          <Box key={accountType} sx={{ animation: `${fadeUp} 0.4s ease` }}>
            ...
            >
              Join millions of professionals using Weana to capture more leads
            ...
            >
              ...
              <Typography sx={{ fontSize: 13, color: "#555" }}>
                ...
                <Box
                  component="span"
                  sx={{ fontWeight: 700, color: "#1A1A3E" }}
                >
                  50,000+ reviews
                </Box>{" "}
                from
      ...
      {accountType !== "self" && (
        <RightPane>
          ...
          >
            <Image
              src="/images/create_account_flower.png"
              alt="flower"
              width={380}
              height={380}
              layout="responsive"
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/tesla_dark.png"
                  alt="tesla"
                  width={120}
                  height={12}
                />
                <Image
                  src="/images/hubSpot_dark.png"
                  alt="hubspot"
                  width={80}
                  height={23}
                />
                <Image
                  src="/images/jpMorgan_dark.png"
                  alt="jpmorgan"
                  width={80}
                  height={16}
                />
              ...
              >
                <Image
                  src="/images/hilton_dark.png"
                  alt="hilton"
                  width={80}
                  height={30}
                />
                <Image
                  src="/images/eagle_dark.png"
                  alt="eagle"
                  width={50}
                  height={50}
                />
