        ...
        <Box sx={{ flex: 1, p: 2.2, overflow: "auto" }}>
          ...
          >
            ...
            >
              ...
              <Typography
                component="span"
                sx={{ fontSize: 13, color: "#6B7280", fontWeight: 500, ml: 0.8 }}
              >
                (3)
              </Typography>
            </Typography>
            ...
            {signatureTemplates.map((template) => (
              <Box
                ...
                sx={{
                  ...
                  py: 2.1,
                  borderBottom:
                    template.id === signatureTemplates.length ? "none" : "1px solid #EEEAF4",
                }}
              >
                <Stack direction="row" spacing={1.8} sx={{ alignItems: "center" }}>
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 16, fontWeight: 600, color: "#17131F" }}>
                      {template.name}
                    </Typography>
                ...
                <Typography sx={{ fontSize: 14, color: "#312A3F", fontWeight: 500 }}>
