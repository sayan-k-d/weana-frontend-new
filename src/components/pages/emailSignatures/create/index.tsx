...
import { Box, IconButton, Paper, Stack, Switch, TextField, Typography } from "@mui/material";
...
function InfoToggleRow({
  ...
  return (
    ...
    >
      <Typography sx={{ fontSize: 14, color: "#2E253C", fontWeight: 500 }}>{label}</Typography>
      <Switch
        checked={checked}
        onChange={(_, v) => onChange(v)}
        sx={{
          "& .MuiSwitch-switchBase.Mui-checked": { color: purple },
          "& .MuiSwitch-switchBase.Mui-checked + .MuiSwitch-track": { bgcolor: `${purple} !important` },
        }}
      />
    </Stack>
  );
    ...
    >
      <Box sx={{ display: "flex", minHeight: "100vh" }}>
        ...
        <Box sx={{ flex: 1, p: 2.2, overflow: "auto" }}>
          <Stack direction="row" spacing={1} sx={{ alignItems: "center", mb: 2.2, pl: 0.4 }}>
            <IconButton
          ...
          >
            <Paper
              ...
              >
                <Typography component="label" sx={{ fontSize: 14, fontWeight: 600, color: "#2E253C" }}>
                  Signature Name{" "}
                ...
                <Typography sx={{ fontSize: 14, fontWeight: 600, color: "#2E253C", mb: 1 }}>
                  Information
                </Typography>
                <Box
                  sx={{
                ...
                >
                  <InfoToggleRow label="Name" checked={toggles.name} onChange={setToggle("name")} />
                  <InfoToggleRow
                    label="Pronouns"
                ...
                >
                  <Box>
                    <Typography sx={{ fontSize: 14, fontWeight: 500, color: "#2E253C" }}>
                      Profile Pic
                    </Typography>
                    <Typography sx={{ fontSize: 12.5, color: "#7B748B", mt: 0.5, maxWidth: 320 }}>
              ...
              >
                ...
                >
                  <Stack direction="row" spacing={2.5} sx={{ justifyContent: "space-between" }}>
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      ...
                      <Typography sx={{ fontSize: 16, fontWeight: 700, color: "#1E1A28" }}>Test</Typography>
                    ...
                    <Box sx={{ textAlign: "center", flexShrink: 0 }}>
                      ...
                      <Typography sx={{ fontSize: 11, fontWeight: 600, color: purple, mt: 0.8 }}>
                ...
                <Typography sx={{ textAlign: "center", fontSize: 13, color: "#6B6578", mt: 2.5 }}>
                  Preview based on <Box component="span" sx={{ fontWeight: 700, color: "#2E253C" }}>John</Box>
                </Typography>
              </Box>
          </Box>
        </Box>
      ...
      <AddContentDialog open={isAddContentOpen} onClose={() => setAddContentOpen(false)} />
    </Box>
  );
}
